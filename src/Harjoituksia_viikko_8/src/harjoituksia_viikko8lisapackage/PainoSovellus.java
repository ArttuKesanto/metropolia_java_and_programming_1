...
public class PainoSovellus {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            tulostaValikko();
            try { // ei vaadittu tehtävänannossa, hyvä olla, jotta saadaan nopeasti kirjattua lisää dataa virheellisen syötteen saapuessa.
                ...
                if (valinta == 0) {
                    ...
                    int paino = Integer.parseInt(jaettu[1]); //annetaan jaettu painomerkintä, sisältää vain integerin.
